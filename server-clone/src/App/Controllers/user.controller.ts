...
const JWT_SECRET_KEY = process.env.JWT_SECRET_KEY || 'Nhana9093';
const JWT_SECRET_KEY_REFRESH_TOKEN = process.env.JWT_SECRET_KEY_REFRESH_TOKEN || 'Nhana9093';
  ...
  static createNewAccessToken(req: Request, res: Response) {
    ...
    jwt.verify(refreshToken, JWT_SECRET_KEY_REFRESH_TOKEN, (err: any, decoded: any) => {
      ...
      res.cookie('refreshToken', newRefreshToken, {
        //Lưu NewrefreshToken vào cookie khi reset thành công
        httpOnly: true,
        secure: true,
        sameSite: 'none',
      });
